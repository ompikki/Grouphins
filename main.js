document.addEventListener('DOMContentLoaded', () => {
  ...
  if (sidebar && sidebarToggle) {
    sidebarToggle.addEventListener('click', (e) => {
      ...
      const expanded = (!sidebar.classList.contains('collapsed')).toString();
      sidebarToggle.setAttribute('aria-expanded', expanded);
    });

    function checkSidebar() {
      if (window.innerWidth <= mobileBreakpoint) sidebar.classList.add('collapsed');
    ...
    document.addEventListener('click', (e) => {
      if (window.innerWidth <= mobileBreakpoint && !sidebar.contains(e.target) && !sidebarToggle.contains(e.target)) {
